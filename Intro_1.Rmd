...
lat = c(-76.65, -75.59, -74.09, -73.13)
lon = c(5.69, 6.26, 4.60, 7.13)
...
ciudades2 <- data.frame(x = lat, y = lon, precip = precip, nombre = c("Quibdo", "Medellín", "Bogotá", "Bucaramanga"))

ggplot(data = ciudades2, aes(x = lat, y = lon)) +
...
mapview(ciudades_geo, zcol = "nombre")
```
### Check the BIEN projection

## Sistema de coordenadas 
### longlat
### eck4 (what is this? from World)

## Ejercicio #2: 

- Busca en internet las coordenadas de 3 ciudades
- Crear un data frame con el nombre de la ciudad y las coordenadas
- Crear una gráfica de los puntos con los límites deseados usando plot o ggplot 
- Convertir el data frame en `SpatialPointsDataFrame` usando la función
- Graficar los puntos usando mapview con y sin proyección geográfica

## Include the map (vectors)
